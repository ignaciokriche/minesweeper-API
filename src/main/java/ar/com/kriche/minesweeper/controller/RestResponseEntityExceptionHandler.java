...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handlePlayerNotFound(RuntimeException ex, WebRequest request) {
        String bodyOfResponse = ex.getMessage();
        return handleExceptionInternal(ex, bodyOfResponse, new HttpHeaders(), HttpStatus.NOT_FOUND, request);
    }

    @ExceptionHandler(value = {InvalidUserNameException.class})
    protected ResponseEntity<Object> handleInvalidUserName(RuntimeException ex, WebRequest request) {
        String bodyOfResponse = ex.getMessage();
